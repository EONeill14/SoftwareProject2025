    ...
    <form action="index.php" method="post" id="register_form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label style="margin-bottom:-0.5rem !important">County</label>
                    <input type="text" class="form-control" name="ship_state" value="<?php echo isset($_SESSION['form_data']['ship_county']); ?>">
                </div>
                <div class="form-group">
                    <label style="margin-bottom:-0.5rem !important">Eircode</label>
                    <input type="text" class="form-control" name="ship_zip" value="<?php echo isset($_SESSION['form_data']['ship_eircode']); ?>">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label style="margin-bottom:-0.5rem !important">County</label>
                    <input type="text" class="form-control" name="bill_state" value="<?php echo isset($_SESSION['form_data']['bill_county']); ?>">
                </div>
                <div class="form-group">
                    <label style="margin-bottom:-0.5rem !important">Eircode</label>
                    <input type="text" class="form-control" name="bill_zip" value="<?php echo isset($_SESSION['form_data']['bill_eircode']); ?>">
                </div>
                <div class="form-group">
                    <label style="margin-bottom:-0.5rem !important">Phone</label>
