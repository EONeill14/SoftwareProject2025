...
<div class="container page-overlay">
    <div class="row">
        ...
        <div class="col-md-2">
            <?php if (get_product_order_count($product_id) == 0) : ?> <!--if not used in Order. -->
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p style="margin-bottom:0px"><a href="../../images/<?php echo $product['productCode']; ?>.png"> View small image</a></p>
        </div>
    </div>
</div>
