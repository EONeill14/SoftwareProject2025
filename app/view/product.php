...
//ad html tage to the deescription
$description = add_tags($description);

//calculate discounts
$discount_percent = round($list_price * ($discount_percent / 100), 2);
...
<div class="row">
    ...
    <div class="col-md-8" style="margin-top:12px">
        <!--display inline block does not add a line-break after the element, so the element can sit next to the other
        elements.Here, product price,discount percent, and unit price sit next to their respective labels-->
        ...
        <p style="display: inline-block; color:rgb(165,165,165)"><?php echo '$' . $unit_price; ?>
